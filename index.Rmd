...
---
> I bought the book "Knowledge is Beautiful" by David McCandless in 2014 and it's been a fantastic coffee table book ever since. I set out to recreate a couple of the data visualizations in R. 
...
I was trying to think of some fun data visualization projects and decided to choose a couple from the book that could be recreated as close to possible in `R`.
